...
<div class="container py-4">
    <h2 class="fw-bold text-dark mb-1">
        <i class="fa-solid fa-credit-card text-danger me-2"></i> Checkout Pesanan
    </h2>
    <p class="text-muted mb-4">Lengkapi data pengiriman dan pilih metode pembayaran</p>
            ...
            <div class="col-lg-7">
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Nomor ini digunakan untuk konfirmasi penerimaan pesanan oleh kedai.</small>
                    </div>

                    <div class="mb-3">
                        <label for="address" class="form-label font-weight-bold text-dark small">Alamat Pengiriman / Pengambilan</label>
                        <textarea name="address" id="address" class="form-control" rows="3" required placeholder="Tuliskan alamat jelas atau ketik 'Diambil Sendiri di Kedai'...">{{ old('address', $user->address) }}</textarea>
                    </div>

                    <div class="mb-0">
                        <label for="notes" class="form-label font-weight-bold text-dark small">Catatan Pesanan (Opsional)</label>
                        <textarea name="notes" id="notes" class="form-control" rows="2" placeholder="Contoh: Sambal dipisah, Indomie agak setengah matang, dll.">{{ old('notes') }}</textarea>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <label class="card h-100 border p-3 cursor-pointer rounded-3 payment-option hover-lift">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="fw-bold text-dark mb-0"><i class="fa-solid fa-qrcode text-danger me-1"></i> QRIS</div>
                                        <small class="text-muted d-block">Scan QR via GoPay, OVO, Dana, ShopeePay, Bank</small>
                                    </div>
                                </div>
                            </label>
                        </div>
                            ...
                            <label class="card h-100 border p-3 cursor-pointer rounded-3 payment-option hover-lift">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted d-block">Bayar langsung saat makanan diambil/diterima</small>
                                    </div>
                                </div>
                            </label>
                        </div>
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm rounded-4 p-4 sticky-top" style="top: 90px;">
                    ...
                    <small class="text-muted text-center d-block mt-3 fs-7">
                        <i class="fa-solid fa-shield-halved text-success me-1"></i> Transaksi Anda diproses aman secara otomatis oleh sistem Kedai Marjuki'S.
                    </small>
                </div>
            </div>
        </div>
