    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'stock' => 50,
                'status' => 'available',
                'image' => 'produk/indomie-biasa.jpg',
            ],
            [
                'name' => 'Indomie Telor',
                'slug' => 'indomie-telor',
                ...
                'stock' => 40,
                'status' => 'available',
                'image' => 'produk/indomie-telor.jpg',
            ],
            [
                'name' => 'Mendoan',
                'slug' => 'mendoan',
                'category_id' => $catCamilan->id,
                'description' => 'Mendoan hangat dan gurih khas Kedai Marjuki\'S disajikan pas untuk teman lauk makan apalagi camilan santai.',
                'price' => 1500,
                'stock' => 50,
                'status' => 'available',
            ...
            [
                ...
                'slug' => 'tahu-bakso',
                'category_id' => $catCamilan->id,
                'description' => 'Tahu bakso lembut isi olahan daging yang nikmat,padat,dan gembul.',
                'price' => 2500,
                'stock' => 50,
                'status' => 'available',
            ...
            [
                ...
                'slug' => 'bakwan-jagung',
                'category_id' => $catCamilan->id,
                'description' => 'Bakwan jagung renyah dan manis gurih racikan bumbu khas Kedai Marjuki\'S.',
                'price' => 1500,
                'stock' => 50,
                'status' => 'available',
